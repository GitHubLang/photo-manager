...
def cube_to_lightroom_xmp(cube_path, output_path, profile_name="LUT Profile"):
    ...
    xmp += '   crs:ProfileName="' + profile_name + '"\n'
    xmp += '   crs:ProfileContentVersion="1.0"\n'
    xmp += '   crs:ProfileCopyright=""\n'
    xmp += '   crs:ProfileCopyrightFlags="0"\n'
    xmp += '   crs:ProfileGroup="LUT"\n'
    xmp += '   crs:ProfileParentPlatform=""\n'
    xmp += '   crs:ProfileEmbedded="False"\n'
    xmp += '   crs:ProfileLookTableEncoding="1">\n'
    xmp += '   <crs:Profile>\n'
    xmp += '    <rdf:Description>\n'
