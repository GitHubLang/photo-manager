...
import { Layout, Select, Button, Space, Tag, Dropdown, Input, message, Typography } from 'antd';
...
export default function FolderPage({
  isMobile, activeMenu, menuCollapsed, setMenuCollapsed,
  handleMenuClick, handleFolderSelect, handleScoreImageClick,
  ...
  // ============ 计算 displayImages ============
  const displayImages = searchHook.searchResults !== null ? searchHook.searchResults : imageHook.images;
      ...
      <Layout>
        ...
        {!isMobile && activeMenu === 'scores' && !menuCollapsed && (
          <ScorePanel
            ...
            onPageChange={() => handleMenuClick('folder')}
